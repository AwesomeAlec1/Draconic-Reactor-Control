...
local updateVariable = term.read({dobreak=false})
...
local pathSelect = term.read({dobreak=false})
...
local stableSelect = term.read({dobreak=false})
...
local canarySelect = term.read({dobreak=false})
...
local legacySelect = term.read({dobreak=false})
...
print("Default: /home/")
local DCPath = term.read({dobreak=false})
